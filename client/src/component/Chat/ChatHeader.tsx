...
const ChatHeader = ({ toggleSidebar }: { toggleSidebar: () => void }) => {
  return (
    <div className="h-20 border-b border-gray-800 flex items-center px-6 gap-4 bg-gray-900/30">
      <button onClick={toggleSidebar} className="p-3 hover:bg-gray-800 rounded-xl">
        <LuMenu size={24} />
      </button>
